...
impl Munger {
    fn start_battle_from_comm_menu(&self, mut core: mgba::core::CoreMutRef) {
    ...
    fn drop_matchmaking_from_comm_menu(&self, mut core: mgba::core::CoreMutRef, typ: u32) {
        core.raw_write_8(self.offsets.ewram.menu_control + 0x0, -1, 0x18);
    ...
    fn local_custom_screen_state(&self, mut core: mgba::core::CoreMutRef) -> u8 {
        core.raw_read_8(self.offsets.ewram.battle_state + 0x11, -1)
    }

    fn local_marshaled_battle_state(&self, mut core: mgba::core::CoreMutRef) -> Vec<u8> {
    ...
    fn set_player_marshaled_battle_state(
        &self,
        mut core: mgba::core::CoreMutRef,
        index: u32,
        marshaled: &[u8],
    ...
    fn set_link_battle_settings_and_background(&self, mut core: mgba::core::CoreMutRef, v: u16) {
        core.raw_write_16(self.offsets.ewram.menu_control + 0x2a, -1, v)
    }

    fn match_type(&self, mut core: mgba::core::CoreMutRef) -> u16 {
        core.raw_read_16(self.offsets.ewram.menu_control + 0x12, -1)
    }

    fn in_battle_time(&self, mut core: mgba::core::CoreMutRef) -> u32 {
